...
class HoverCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double cardWidth = Constants.desktopwidth * 0.18; // 70% of screen width
    double cardHeight = Constants.desktoopheight * 0.4; // 40% of screen height
    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          top: -Constants.desktoopheight * 0.18, // Adjust based on screen height
