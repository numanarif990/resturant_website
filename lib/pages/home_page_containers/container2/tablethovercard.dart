...
class TabletHoverCard extends StatelessWidget {
  final String image;
  final String title;
  final String description;
  const TabletHoverCard({
    super.key,
    required this.image,
    required this.title,
  ...
  Widget build(BuildContext context) {
    ...
    double cardWidth = size.width * 0.50; // 70% of screen width
    double cardHeight = size.height * 0.30; // 40% of screen height
