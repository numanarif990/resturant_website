...
class MobileContainer3RightPart extends StatelessWidget {
  const MobileContainer3RightPart({
    super.key,
    required this.size,
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text("Wecome to Our \nRestaurant",style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold, height: 0),textAlign: TextAlign.center,),
