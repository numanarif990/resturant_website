...
class ContainerLeftPart extends StatelessWidget {
  const ContainerLeftPart({
    super.key,
    required this.size,
  });
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const Text("We provide the \nbest food for you",style: TextStyle(fontSize: 50, fontWeight: FontWeight.bold, height: 0),),
